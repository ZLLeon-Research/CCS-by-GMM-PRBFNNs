function [varargout,model,L] = gmmC(X, K_or_centroids,Centers)
% ============================================================
...
%          Px = calc_prob(); 
        ...
        pGamma = pGamma ./ repmat(sum(pGamma, 2), 1, K);  %membership
    ...
    function Px = calc_prob()
        ...
        for k = 1:K
            ...
            inv_pSigma = inv(conv);
            tmp = sum((Xshift*inv_pSigma) .* Xshift, 2);%(X-U_k)sigma.*(X-U_k),tmp
